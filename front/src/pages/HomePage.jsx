        ...
        <div className="container-fluid">
          ...
          <div className="row">
            ...
            <div className="col-sm-6 col-lg-7 bg-white p-5 ">
              ...
              <p className="p-1">
                Esta sala íntima y acogedora proporciona el escenario perfecto
                para sesiones de trabajo colaborativas y productivas, brindando
                un espacio tranquilo y estimulante para potenciar la creatividad
                y la concentración del equipo.
              </p>
              <Link to="/">
          ...
          <div className="row">
            <div className="col-sm-6 col-lg-7 bg-white p-5 order-sm-1 order-last">
              ...
              <p className="p-1">
                Sala con diez puestos de trabajo flexibles, perfecta para la
                modalidad de sillas calientes. Aquí puedes elegir y adaptar tu
                espacio según tus necesidades y disponibilidad horaria. Con un
                diseño contemporáneo y funcional, esta sala ofrece un entorno
                dinámico que promueve la productividad y la interacción entre
                los equipos.
              </p>
              <Link to="/">
                RESERVA ESTA SALA <FontAwesomeIcon icon={faArrowRight} />
          ...
          <div className="row">
            ...
            <div className="col-sm-6 col-lg-7 bg-white p-5">
              ...
              <p className="p-1">
                Sumérgete en un entorno espacioso y tranquilo, perfecto para ver
                clases, estudiar y trabajar en equipo. Equipada con cómodos
                asientos, esta sala brinda un ambiente propicio para la
                concentración y el intercambio de conocimientos de nuestros
                alumnos de Factoria F5. El objetivo es proporcionar un espacio
                de estudio excepcional donde puedas explorar, crecer y alcanzar
          ...
          <div className="row">
            <div className="col-sm-6 col-lg-7 bg-white p-5 order-sm-1 order-last">
              ...
              <p className="p-1">Aforo máximo recomendado: 25 personas.</p>
              <p className="p-1">
                Esta sala de estudio te invita a adentrarte en un océano de
                sabiduría, rodeado de un ambiente estimulante y envolvente. El
                aula Hedy Lamar llevará a nuestros estudiantes de Factoria F5 a
                un viaje de descubrimiento intelectual, desafiando los límites
                de su aprendizaje.
              </p>
              <Link to="/">
                RESERVA ESTA SALA <FontAwesomeIcon icon={faArrowRight} />
          ...
          <div className="row">
            ...
            <div className="col-sm-6 col-lg-8 bg-white p-5">
              ...
              <p className="p-1">
                Puesto individual para conectarse a reuniones que requieren de
                más privacidad y silencio.
              </p>
              <Link to="/">
                RESERVA ESTA SALA <FontAwesomeIcon icon={faArrowRight} />
              </Link>
